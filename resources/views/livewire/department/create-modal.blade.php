<div x-data="{ open: @entangle('openCreateModal') }" x-cloak @keyup.escape.window="open = false">
    ...
    <div x-show="open" x-transition:enter="transition ease-out duration-500" x-transition:enter-start="opacity-0"
        ...
        <div @click.outside="$wire.set('openCreateModal', false)" x-show="open"
            ...
            x-transition:leave-end="opacity-0 scale-50 translate-y-8" class="bg-white p-6 rounded-lg w-full max-w-lg">
